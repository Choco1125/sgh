...
const Crear = ({alerta,update}) => {
    ...
    const save = async()=>{
        ...
        if(validator.validarDatos(datos)){
            let res = await consumidor.post('positions',datos);
            console.log(res);
    ...
    return (
        <div 
            className="modal fade" id="crear" data-backdrop="static" role="dialog" 
            ...
            <div className="modal-dialog" role="document">
                <div className="modal-content">
                    <div className="modal-header">
                        <h5 className="modal-title" id="crearLabel">Crear posición</h5>
