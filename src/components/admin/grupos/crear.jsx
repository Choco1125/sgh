...
const Crear = ({alerta,actualizar,modalidades,usuarios,programasFromacion,aprendices})=>{
    ...
    const guradar = async ()=>{
        ...
        if(validator.validarDatos(datos)){
            ...
            if(res === 'Nuevo grupo creado'){
                ...
                $('#crear').modal('hide');
                alerta('Ha ocurrido un error en el servidor, vuelve a intentarlo','danger');
                console.error(res);
            }
            setCodeTab('');
            setModalidad('');
            ...
            <div className="modal-dialog" role="document">
                <div className="modal-content">
                    <div className="modal-header">
                        <h5 className="modal-title" id="crearLabel">Crear grupo</h5>
                    ...
                    <div className="modal-body">
                        ...
                        <div className="form-group mt-1" id="codeTab">
                            <label htmlFor="codeTab">ID <span className="text-danger">*</span></label>
                            <input type="text" className="form-control" placeholder="Id del programa" 
                                name="codeTab" 
                                value={codeTab} 
                        ...
                        <div className="form-group" id="modalityId">
                            <label htmlFor="modalityId">Modalidad <span className="text-danger">*</span></label>
                            <Select
                                value = {modalidad}
                        ...
                        <div className="form-group" id="quantityLearners">
                            <label htmlFor="quantityLearners">Número de aprendices <span className="text-danger">*</span></label>
                            <input type="number" className="form-control" placeholder="Cantidad de aprendices" 
                                min = "0"
                                max = "100"
                        ...
                        <div className="form-group" id="activeLearners">
                            <label htmlFor="activeLearners">Número de aprendices activos<span className="text-danger">*</span></label>
                            <input type="number" className="form-control" placeholder="Cantidad de aprendices activos" 
                                min = "0"
                                max = "100"
                                name="activeLearners" 
                        ...
                        <div className="form-group" id="electiveStartDate">
                            <label htmlFor="electiveStartDate">Feha inicio etapa electiva<span className="text-danger">*</span></label>
                            <input type="date" className="form-control" placeholder="Feha inicio etapa electiva" 
                        ...
                        <div className="form-group" id="electiveEndDate">
                            <label htmlFor="electiveEndDate">Feha fin etapa electiva<span className="text-danger">*</span></label>
                            <input type="date" className="form-control" placeholder="Feha fin etapa electiva" 
                        ...
                        <div className="form-group" id="practiceStartDate">
                            <label htmlFor="practiceStartDate">Feha inicio etapa práctica<span className="text-danger">*</span></label>
                            <input type="date" className="form-control" placeholder="Feha inicio etapa práctica" 
                        ...
                        <div className="form-group" id="practiceEndDate">
                            <label htmlFor="practiceEndDate">Feha fin etapa práctica<span className="text-danger">*</span></label>
                            <input type="date" className="form-control" placeholder="Feha fin etapa práctica" 
                        ...
                        <div className="form-group" id="managerId">
                            <label htmlFor="managerId">Gefe de grupo <span className="text-danger">*</span></label>
                            <Select
                                value = {managerId}
                        ...
                        <div className="form-group" id="offer">
                            <label htmlFor="offer">Oferta <span className="text-danger">*</span></label>
                            <input type="text" className="form-control" placeholder="Oferta" 
                                name="offer" 
                                value={offer} 
                        ...
                        <div className="form-group" id="formationProgramId">
                            <label htmlFor="formationProgramId">Programa de formación <span className="text-danger">*</span></label>
                            <Select
                                value = {formationProgramId}
                                onChange = {({label, value}) => setFormationProgramId({label,value})}
                                options = {programasFromacion}
                            />
                            <span className="text-danger"></span>
                        </div>
                        <div className="form-group" id="groupState">
                            <label htmlFor="groupState">Estado <span className="text-danger">*</span></label>
                            <select name="groupState" className="custom-select"
