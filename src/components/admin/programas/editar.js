    ...
    if (this.props.datos.code !== "") {
      if (this.props.datos.name !== "") {
        if (this.props.datos.formationTypeId !== "") {
          try {
            let datos = await Api(
              `formationPrograms/${this.props.datos.id}`,
              "PUT",
              sessionStorage.getItem("token"),
              this.props.datos
            );
            if (datos === "Programa de formacion actualizado") {
              ...
              datos.message === "Este programa de formacion ya existe"
            ) {
              $("#editar").modal("hide");
          ...
          this.agregarError(
            document.getElementById("formationTypeId_edit"),
            ...
            <div className="modal-body">
              ...
              <div className="form-group mt-1" id="code_edit">
                <label htmlFor="code">
                  ...
                  <button
                    ...
                    title="Corresponde al código y la versión del programa de formación"
                  >
              ...
              <div className="form-group" id="isRegisterQualified_edit">
                <div className="custom-control custom-switch">
                  <input
                    ...
                    id="switch1"
                    checked={this.props.datos.isRegisterQualified}
                    onChange={() => this.props.changeQualifiqued()}
                  />
              ...
              {this.props.datos.isRegisterQualified ? (
                <div className="form-group" id="isRegisterQualifiedDate_edit">
                  <label htmlFor="isRegisterQualifiedDate">
