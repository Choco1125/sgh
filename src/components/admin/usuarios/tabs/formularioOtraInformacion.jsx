        ...
        <div className="card-body">
            ...
            <div className="mt-1 mb-2">
                <div className="custom-control custom-switch">
                    <input type="checkbox" className="custom-control-input" id="customSwitch1" onChange = { () => setIsBossArea(!isBossArea)}/>
            ...
            <div className="form-group" id="last_academic_level">
                <label htmlFor="last_academic_level">Último nivel académico</label>
