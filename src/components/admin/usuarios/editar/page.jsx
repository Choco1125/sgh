...
const EditarUserPage = ()=>{
  ...
  const getCargos = async () => {
    ...
    let cargosArr = [];
    if(datos){
      datos.map(cargo => cargosArr.push({
	label: cargo.name,
	value: cargo.id
      }));
      setCargos(cargosArr);
  ...
  useEffect(()=>{
    async function getInfo() {
      ...
      setContractType({label: datos.contractType.name, id: datos.contractType.id});
    ...
    <div className="container">
      <div className="row mt-3">
        <div className="col-lg-3">
          <img src="https://image.freepik.com/vector-gratis/sigueme-diseno-tematica-social-empresarial_24877-50426.jpg" alt="User" style={{height: 250}}/>
        </div>
