    ...
    <div className="container">
      <div className="row mt-3">
        ...
        <div className="col-lg-7">
          ...
          <div className="tab-content card card-body" id="nav-tabContent">
            <div className="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
              <div className="form-group" id="document">
                  ...
                  <input type="number" placeholder="Documento del usuario" name="document" className="form-control" />
                  <span className="text-danger"></span>
              </div>
              <div className="form-group" id="username">
                  <label htmlFor="username">Nombres <span className="text-danger">*</span></label>
                  <input type="text" placeholder="Nombre del usuario" name="username" className="form-control" />
                  <span className="text-danger"></span>
              </div>
              ...
              <div className="form-group" id="genere">
                  ...
                  <div className="form-check form-check-inline">
                      <input className="form-check-input" type="radio" name="genere" id="Femenenino" value="Femenino" defaultChecked/>
                      <label className="form-check-label" htmlFor="Femenenino">Femenenino</label>
                  </div>
                  <div className="form-check form-check-inline">
                      <input className="form-check-input" type="radio" name="genere" id="Masculino" value="Masculino"/>
