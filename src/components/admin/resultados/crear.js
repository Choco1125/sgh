...
class Crear extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      competencias: [],
      programaFormacion: {
        label: "Selecciona un programa de formación",
        value: "",
      },
    };
  }
  ...
  async componentDidMount() {
    ...
    let response = await consumidor.get("formationPrograms");
    if (response) {
      let programas = [];
            ...
            if (this.state.datos.associatedTrimesters !== "" && is_valid) {
              if (this.state.datos.competenceId.value !== "") {
                if (this.asociatedValid()) {
                  ...
                  agregarError(
                    document.getElementById("associatedTrimesters"),
                    "Debes ingresar únicamente números"
                  );
                }
              } else {
                agregarError(
                  document.getElementById("competenceId"),
              ...
              agregarError(
                document.getElementById("associatedTrimesters"),
                "Debes llenar este campo con datos válidos"
              );
            }
          } else {
            agregarError(
              document.getElementById("trimesterEvaluate"),
              "Debes llenar este campo"
            );
          }
        } else {
          agregarError(
            document.getElementById("projectPhase"),
            "Debes llenar este campo"
          );
        }
      } else {
  ...
  setCompotencesOfThisProgram(programId) {
    let competencias = this.props.competencias.filter(
      (competencia) => competencia.programaFormacion === programId
    );
    this.setState({ competencias });
  }

  handleChangeProgram(programaFormacion) {
    this.setState({ programaFormacion });
    this.setCompotencesOfThisProgram(programaFormacion.value);
  }
          ...
          <div className="modal-content">
            ...
            <div className="modal-body">
              ...
              <div className="form-group" id="competenceId">
                <label htmlFor="competenceId">
                  Programa de formación
                  <span className="text-danger">*</span>
                </label>

                <Select
                  value={this.state.programaFormacion}
              ...
              <div className="form-group" id="competenceId">
                ...
                <Select
                  value={this.state.datos.competenceId}
              ...
              <div className="form-group" id="associatedTrimesters">
                <label htmlFor="associatedTrimesters">
            ...
            <div className="modal-footer">
              ...
              <button
                ...
                onClick={() => this.save()}
              >
                Crear <i className="fas fa-save mr-1"></i>
